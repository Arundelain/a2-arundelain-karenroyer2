...
// setup up initial values of data
  ...
  // talks to the server. sends on submit button of some kind. body:JSON.stringify(appData or in this case object named json by the programmer)
  // .then(res=>{//do some function operation in here push or what have you to the data base file})
    fetch( '/submit', {
      method:'POST',
      body 
    })
